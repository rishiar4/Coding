public class Solution{
    ...
    public static boolean findR( Node root, int data)
    {
       if( root == null ) return false;

       if( root.data == data ) return true;

       if( root.data > data ) return findR( root.left, data );
        
       if( root.data < data ) return findR( root.right, data );
    ...
    public static void solve()
    {
        ...
        System.out.println( findR( root, -120 ) );

        System.out.println( findR( root, 50 ) );
    }
